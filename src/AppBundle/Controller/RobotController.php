...
{
    /**
     * @Route("/admin/exportarRobots", name="exportar_robots_excel")
     * @Method("GET")
     */
    public function exportarRobotsExcelAction()
    {
        ...
        $robots = $em->getRepository('AppBundle:Robot')->findRobots();
        ...
        for ($i=0; $i < count($robots); $i++) {
            $phpExcelObject->setActiveSheetIndex(0)->setCellValue('A'.((string)$i+2), $robots[$i]['nombre']);
        }
